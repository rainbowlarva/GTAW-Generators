// Unique prefix for property release page fields to avoid conflicts with other pages.
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Restore saved field values and attach listeners for auto-saving using a unique key prefix
  ...
  // Auto-expand any textareas based on content (if any exist)
...
[/table2]`;
  ...
  // Replace each occurrence of "NAMEHERE" sequentially with the values from field1 to field18
  for (let i = 1; i <= 18; i++) {
    const field = document.getElementById("field" + i);
